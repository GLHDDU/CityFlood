...
#define  PRODUCTKEY           "a1M3bxloYlJ"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "neilao"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "529a7936187fd6c95903b58356571350"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1M3bxloYlJ/neilao/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1M3bxloYlJ/neilao/thing/event/property/post"    //需要发布的主题     
